...
const CustomizeNumber = () => {
    return (
        <div className='flex flex-row mx-auto items-center justify-center mt-0 bg-gray-100 sm:flex-col xs:flex-col'>

            <div className='flex flex-col sm:flex-row'>
                <div className="mx-5 my-5 w-72 h-64 xs:w-48 xs:h-44 rounded-lg bg-white xyzabc2">
            ...
            <div className='flex flex-col text-center xs:order-first sm:flex-row'>
                <div className='mx-5 my-5 w-72 h-64 xs:w-48 xs:h-44 rounded-lg bg-white flex items-center justify-center xyzabc2 hover:border-2'>
